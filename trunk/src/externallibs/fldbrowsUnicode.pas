...
var
  ProductCode,
  FeatureId,
  ComponentCode : array[0..MAX_PATH]of AnsiChar;
...
begin
  ...
  ZeroMemory(@ComponentCode, sizeof(ComponentCode));
	...
	if(MsiGetShortcutTarget(PAnsiChar(AnsiString(LnkFile)), ProductCode, FeatureId,
  ...
  begin
    ...
    case MsiGetComponentPath(ProductCode, ComponentCode, Path, @PathLen) of
      INSTALLSTATE_LOCAL,
      INSTALLSTATE_SOURCE:
				SetString(Result, Path, lstrlenA((Path)));
    end;
  end;
end;
